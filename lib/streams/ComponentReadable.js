...
class ComponentReadable extends Readable {
  ...
  _foundComponentHandler (tagDetails, parentComponent) {
    ...
    if (tagDetails.name === BODY_TAG) {
      ...
      var hydrationScript = this._context.getHydrationScript();
    ...
    if (isDocument) {
      ...
      component = this._transformDescriptorToComponent(descriptor);
    }
   ...
   * @private
   */
  _transformDescriptorToComponent (descriptor) {
